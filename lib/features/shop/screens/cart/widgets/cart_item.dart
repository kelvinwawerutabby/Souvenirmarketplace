      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              const SBrandTitleWithVerification(title: 'Nike'),
              const Flexible(child: SProductTitleText(title: 'Black Sport Shoes', maxLines: 1)),
              ...
              Text.rich(
                  TextSpan(
                      children: [
                        ...
                        TextSpan(text: 'EU 31', style: Theme.of(context).textTheme.bodyLarge),
                      ]
                  )
              )
            ],
